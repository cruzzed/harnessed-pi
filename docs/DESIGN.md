...
there. (Verified: `/home/franki` inside contains only the project.)
...
extension — pi auto-discovers `index.ts`). Never edit the deployed copy. Original policy from `docs/piagent.md`
